...
easily be interchanged. All dependencies, gems and client side components are already included.}
  ...
  spec.add_runtime_dependency 'inherited_resources', '1.4.1'
#  spec.add_runtime_dependency 'responders', '1.0.0.rc'
#  spec.add_runtime_dependency 'desponders', '0.3.0'
  spec.add_runtime_dependency 'has_scope', '0.6.0.rc'
  spec.add_runtime_dependency 'carrierwave', '0.9.0'
  spec.add_runtime_dependency 'country_select', '1.2.0'
#  spec.add_runtime_dependency 'tabulous', '2.1.0'
  spec.add_runtime_dependency 'kaminari', '0.15.0'
#spec.add_runtime_dependency 'ar-audit-tracer', '2.0.0'
#  spec.add_runtime_dependency 'paper_trail', '3.0.0'
  spec.add_runtime_dependency 'haml-rails', '0.5.3'
#  spec.add_runtime_dependency 'ruby-haml-js', '0.0.5'
